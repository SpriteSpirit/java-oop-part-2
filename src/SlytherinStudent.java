public class SlytherinStudent extends HogwartsStudent{
    ...
    public void compareSlytherin(SlytherinStudent slytherinStudent) {
        ...
        if (ability1 > ability2) {
            System.out.printf("Student %s is better then student %s%n", getName(), slytherinStudent.getName());
        } else if (ability2 > ability1) {
            System.out.printf("Student %s is better then student %s%n", slytherinStudent.getName(),getName());
        } else {
            System.out.printf("Student %s is like student %s%n", slytherinStudent.getName(),getName());
        }
    }
    ...
    public String toString() {
        return String.format("%s; cunning: %d; determination: %d; ambition: %d; ingenuity: %d; thirstForPower: %d",
